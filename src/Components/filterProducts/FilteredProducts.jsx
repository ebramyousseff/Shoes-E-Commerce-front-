...
import { filterProducts,
  ...
  sortByPrice,
  filterByColor,
  filterBySize,} from '../../features/slices/productsSlice'
  ...
  return (
    <div>
      <div className="pt-16">
                ...
                return (
                  <div key={index}>
                    <Button
                      ...
                      variant="outlined"
                      ripple="true"
                      className="text-black hover:hg-gray-300 duration-300 ease-in-out mr-4"
        ...
        {error ? <Error/>:<div className="grid grid-cols-4 justify-items-center py-8 gap-12">
          {products
