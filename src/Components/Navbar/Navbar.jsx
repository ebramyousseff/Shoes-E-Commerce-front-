...
const Navbar = () => {
  const totalAmaount = useSelector((state) => state.cart.totalAmount);
  ...
  return (
    <>
      <div>
        <div className="bg-black p-4 w-full justify-center items-center">
        ...
        <div className="flex justify-around items-center">
          ...
          <div onClick={()=>dispatch(logout())}>
            <Tooltip content="Sign Out" placment="bottm">
